...
for s in "${services[@]}"; do
    ...
    go mod edit -replace github.com/siralfbaez/mia-agentic-data-nervous-system-kfg-v3/pkg/observability=../../pkg/observability
    go mod edit -replace github.com/siralfbaez/mia-agentic-data-nervous-system-kfg-v3/pkg/resilience=../../pkg/resilience
    go mod tidy
    cd ../..
done
